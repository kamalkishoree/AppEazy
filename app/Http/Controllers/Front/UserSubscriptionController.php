...
use App\Models\{User, UserAddress, ClientPreference, Client, ClientCurrency, SubscriptionPlansUser, SubscriptionFeaturesListUser, SubscriptionInvoicesUser, SubscriptionInvoiceFeaturesUser, Payment, PaymentOption, ShowSubscriptionPlanOnSignup};
...
class UserSubscriptionController extends FrontController
{
    ...
    public function getSubscriptionPlans(Request $request, $domain = '')
    {
        ...
        $show_subscription_plane = ShowSubscriptionPlanOnSignup::first();
        ...
        return view('frontend.account.userSubscriptions')->with([
            ...
            'showSubscriptionPlane' => $show_subscription_plane
        ]);
    }
