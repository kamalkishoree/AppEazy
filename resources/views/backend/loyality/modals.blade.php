                                                ...
                                                @endif
                                                    @if($langs->is_primary == 1)
                                                        <td >
                                                            ...
                                                            {!! Form::text('name_translation['.$langs->language_id.']', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                                        </td>
                                                    @else
                                                        <td >
                                                            <!-- {!! Form::hidden('name_language_id[]', $langs->language_id) !!} -->
                                                            {!! Form::text('name_translation['.$langs->language_id.']', null, ['class' => 'form-control']) !!}
                                                        </td>
                                                    @endif
                                                @endforeach
                                            </tr>
                                                ...
                                                @endif
                                                    @if($langs->is_primary == 1)
                                                        <td >
                                                            ...
                                                            {!! Form::text('description_translation['.$langs->language_id.']', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                                        </td>
                                                    @else
                                                        <td >
                                                            <!-- {!! Form::hidden('description_language_id[]', $langs->language_id) !!} -->
                                                            {!! Form::text('description_translation['.$langs->language_id.']', null, ['class' => 'form-control']) !!}
                                                        </td>
                                                    @endif
                                                @endforeach
                                            </tr>
