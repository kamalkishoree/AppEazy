                                ...
                                <tr>
                                    @foreach($languages as $langs)
                                        <td>
                                            ...
                                            <input type="text" name="title[]" value="{{(isset($langs->vendorSubsTrans) && !empty($langs->vendorSubsTrans->title)) ? $langs->vendorSubsTrans->title : ''}}" class="form-control" @if($langs->is_primary == 1) required @endif>
                                        </td>
                                    @endforeach
                                </tr>
                            </table>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-borderless table-responsive al_table_responsive_data mb-0" id="edit_brand-datatable" >
                                ...
                                <tr>
                                    @foreach($languages as $langs)
                                        <td>
                                            <input type="text" name="description[]" value="{{(isset($langs->vendorSubsTrans) && !empty($langs->vendorSubsTrans->description)) ? $langs->vendorSubsTrans->description : ''}}" class="form-control" @if($langs->is_primary == 1) required @endif>
                                        </td>
                                    @endforeach
                                </tr>
                            </table>
