        ...
        <div class="row">
                                ...
                                @if ($product->is_vendor_closed == 1 && $product->closed_store_order_scheduled == 0)
                                    ...
                                    <div class="col-12">
                                        <div class="text-danger">
                                            <i
                                                class="fa fa-exclamation-circle"></i>{{ getNomenclatureName('Vendors', true) . __(' is not accepting orders right nowss.') }}
                                        </div>
                                    </div>
            ...
            --}}
                ...
                @else  --}}
                            ...
                            @else
                                ...
                                @else
                                    <input type="hidden" name="cart_tip_amount" id="cart_tip_amount"
                                        value="0">
                                    <input type="hidden" name="cart_total_payable_amount"
                                        value="{{ decimal_format($cart_details->total_payable_amount  ?? 0) + decimal_format($other_taxes) }}">
                                @endif
                            @endif
                            {{-- till date --}}
                            <hr class="my-2">
                        ...
                        @if($cart_details->is_recurring_booking != 1 && $serviceType != 'rental' && $serviceType != 'car_rental')
                        ...
                        @endif
                            ...
                            <div class="col-sm-6 col-lg-12 mt-2 text-sm-right cart-checkout_btn">
                                ...
                                @else
                                    @if ($cart_error_message == '')
                                        <button id="order_placed_btn" class="btn btn-solid " type="button"
                                        {{ $disablePlaceBtn}}>{{ __('Place Order') }}</button>
                                    @else
                                        <div class="alert p-0" role="alert">
                                            <div class="alert-danger p-1">{{ $cart_error_message }}</div>
