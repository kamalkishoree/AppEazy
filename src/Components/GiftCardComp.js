        ...
        // backgroundColor: 'red' 
            ...
            <FastImage
                ...
                style={{ 
                    ...
                    height: moderateScaleVertical(width / 2.6),
                    borderRadius:moderateScale((width / 2.6)/2),
            ...
            >
                ...
                padding:8,
                    borderRadius:moderateScale(10),left:16,zIndex:1, top:30,
            ...
            <View style={{ padding:4, marginTop:moderateScaleVertical(10)}} >
                <Text style={{
                    ...styles.updateBilling,
                    color: colors.black,
...
export default React.memo(GiftCardComp);
