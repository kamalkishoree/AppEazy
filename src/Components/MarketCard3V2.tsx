...
const MarketCard3: FC<CompProps> = ({
  ...
  if (!!data?.lineOfSightDistance) {
    vendorDistance =
      typeof data?.lineOfSightDistance == 'string'
        ? Number(data?.lineOfSightDistance.split(' ')[0]).toFixed(1)
        : data.lineOfSightDistance.toFixed(1);
  }
  ...
  //       : data.lineOfSightDistance.toFixed(3);
  // }
            ...
            {!!data?.lineOfSightDistance && (
              <View
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  />
                  {getBundleId() == appIds.bumprkar?<Text
                    numberOfLines={1}
                    style={{
                      ...styles.distanceTimeStyle,
                    }}>
               {vendorDistance} Miles
                  </Text>:<Text
                    numberOfLines={1}
                    style={{
                      ...styles.distanceTimeStyle,
