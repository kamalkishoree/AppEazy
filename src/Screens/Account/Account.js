    ...
    return (
        ...
        >
            ...
            <View style={{
               ...
               {getBundleId() !== appIds.bumprkar && <LeftImgRightTxt onPress={moveToNewScreen(navigationStrings.SERVICE_SLOTS)} leftImgSrc={imagePath.time} rightTxt={strings.DATE_TIME} />}
                {getBundleId() !== appIds.bumprkar && <LeftImgRightTxt onPress={moveToNewScreen(navigationStrings.PRODUCTS_PRICE)} leftImgSrc={imagePath.icPayout} rightTxt={strings.SERVICE_DETAILS} />}
