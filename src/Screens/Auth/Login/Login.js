...
import { cancelRequest } from '../../../redux/actions/auth';
...
export default function Login({ navigation, route }) {
  ...
  const _onLogin = () => {
    ...
    if (checkValid) {
      ...
      actions.login(data, { client: clientInfo?.database_name })
        .then(res => {
      ...
      <View
        ...
        <KeyboardAwareScrollView
          ...
          <View style={styles.bottomSectionStyle}>
            <Text style={styles.loginUsing}>{getBundleId()==appIds.glavour?strings.LOGINUSING+' '+strings.PHONENUMBER: strings.LOGINUSING}</Text>
            {getBundleId()!=appIds.glavour?<Text style={styles.loginUsing}>{strings.PHONENUMBER}</Text>:null}
