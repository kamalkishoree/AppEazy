...
console.log(themeColors,'themeColorsthemeColorsthemeColors')
  ...
  const _confirmAndPay = () => {
    ...
    data['remaing_amount'] = selectedCarOption?.remaining_amount - ( updatedAmount ? updatedAmount : 0);
    data['wallet_amount_used'] = selectedCarOption?.wallet_amount_used - ((Number(selectedCarOption?.remaining_amount) == 0  && updatedAmount) ? updatedAmount : 0);
