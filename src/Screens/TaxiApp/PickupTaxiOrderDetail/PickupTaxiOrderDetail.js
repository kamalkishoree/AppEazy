    ...
    return (
      <View style={{ marginBottom: moderateScaleVertical(16) }}>
        ...
        <View style={{ marginHorizontal: moderateScale(16) }}>
          ...
          {console.log(orderFullDetail?.order_details, 'orderFullDetail?.order_details')}


          {!!orderFullDetail?.order_details?.loyalty_amount_saved &&
            Number(orderFullDetail?.order_details?.loyalty_amount_saved) !==
            0 && (
              <View>
                <LeftRightText
