...
// export const API_BASE_URL = 'https://mozmarcas.rostaging.com/api/v1'; 
...
//export const API_BASE_URL = 'http://192.168.103.44:8001/api/v1'
...
// export const API_BASE_URL = 'https://maxisdelivery.com/api/v1';
...
// blacnetwork
//  export const API_BASE_URL = 'https://blacnetwork.app/api/v1';
...
// export const API_BASE_URL = 'https://ipickndrop.com/api/v1';x
...
// export const API_BASE_URL = 'https://knockknock.market/api/v1';
...
// export const API_BASE_URL = 'https://hellodeliver.in/api/v1';
// export const API_BASE_URL = 'https://yohopartner.com/api/v1xr'
...
//export const API_BASE_URL = 'https://bumprkar.com//api/v1'
//zonesso
...
//Dropoff
// export const API_BASE_URL = 'https://beu.mv/api/v1';

//Zuluclutch
// export const API_BASE_URL = 'https://zuluclutch.com/api/v1';

//Oaks
// export const API_BASE_URL = 'https://oaksride.com/api/v1';

// export const API_BASE_URL='https://dot-taxi.com/api/v1'

//ParcelWorks
// export const API_BASE_URL = 'https://parcelworksdelivery.com/api/v1';

//export const API_BASE_URL='https://livraizoo.com/api/v1'
// export const API_BASE_URL='https://ijamx.com/api/v1'

//export const API_BASE_URL='https://carryfood.org/api/v1'

// export const API_BASE_URL = 'https://kartandkarry.com/api/v1';
