export default {
    ...
    OR_SIGNUP_WITH: 'O Regístrate',
    OR_CONTINUE_WITH: 'O Continua',
    OR_LOGIN_WITH: 'O Inicia Sesión',
    ...
    ENTER_CONFIRM_PASS: 'Confirme su Contraseña *',
    ...
    COMMENTFORVENDOR: 'Comentario para el negocio',
    ...
    VENDOR_ADDRESS: 'dirección del negocio',
    ENTER_VENDOR_NAME: 'nombre del negocio',
    YOUR: 'tu',
    ...
    A_TO_Z: 'A a Z',
    Z_TO_A: 'Z a A',
    COST_LOW_TO_HIGH: 'Precio: Menos a Mas',
    COST_HIGH_TO_LOW: 'Precio: Mas a Menos',
    REPEAT_ORDER: 'Orden Repetida',
    PENDING_ORDERS: 'Ordenes Pendientes',
    CANCELLED_ORDER: 'Ordernes Canceladas',
    ...
    READY_FOR_PICKUP:"Lista para Recogerlo",
    READY_FOR_DEPARTURE:"Listo por Salir",
    REFUNDS: 'Reembolsos',
    ...
    ENTER_NEW_ADDRESS: 'nueva direccion',
    PRODUCT_ORDER_FORM: 'Product Order Form',
    FIXED_FEE: 'Cuota fija',
    SELECT_VENDOR: 'Selecciona un establecimiento',
    ORDERS: 'Pedidos',
    RECENTORDERS: 'Ordenes Recientes',
    BOOK_FOR_A_FRIEND: 'Reserva para un amigo',
    ENTER_FRIEND_DETAILS: "Ingresa los datos de tu amigo",
    BOOK_FOR_ME: 'Reserva para mi',
    BOOK_FOR_FRIEND: 'Reserva para un amigo',
    NOPRODUCTFOUND: 'No se encontró ningún producto',
    BOOK_A_TABLE: 'Reservar una mesa',
    PLEASE_SELECT_A_TABLE: 'Por favor seleccione una mesa',
    SELECT_A_TABLE: 'Selecciona una Mesa',
    SERVICE_ADDRESS: 'Dirección de Servicio',
    BOOK_HERE: 'Reserva Aquí',
    DELETE_ACCOUNT: 'Eliminar Cuenta',
    ARE_YOU_SURE_YOU_WANT_TO_DELETE:
      '¿Estás seguro de que deseas eliminar tu cuenta? Eliminar su cuenta es permanente y eliminará todo el contenido y la configuración del perfil.',
    WR_ARE_CURRENTLY_NOT_OPERATING:
      'Actualmente no estamos operando en su ubicación.',
    WE_ACCEPT_ONLY_SCHEDULE_ORDER: 'Aceptamos solo pedidos programados',
    SOS: 'SOS',
    VISIT_INSTAGRAM: 'Visita nuestro Instagramm',
    CATEGORY_KYC: 'Categooria KYC',
    STORES_CAHT: 'Chat del establecimiento',
    DRIVER_CHAT: 'Chat con el Conductor',
    USER_CHAT: 'Chat del Usuario',
    VENDOR_CHAT: 'Chat del Establecimiento',
    CHAT_EMPTY_ROOM: 'Chat Room Vacio',
    CHAT_ROOM: 'Chat Room',
    PARTICIPANTS: 'Participantes',
    VENDOR: 'Establecimiento',
    START_CHAT: 'Comienza el Chat',
    MINIMUM_ORDER_VALUE: 'Valor mínimo de pedido',
    ORDER: 'Pedidos',
    THANKS_FOR_ORDERING_WITH_US: 'Gracias por ordenar con nosotros',
    TOLL_FEE: 'Tarifa de Peaje',
    SERVICE_CHARGES: 'Cargo de Servicio',
